...
def main():
	...
	tmp_result = f'temp/result-{uuid.uuid1()}.avi'
	...
	if not args.audio.endswith('.wav'):
		...
		command = 'ffmpeg -y -i {} -strict -2 {}'.format(args.audio, tmp_wav)
	...
	command = 'ffmpeg -y -i {} -i {} -strict -2 -q:v 1 {}'.format(args.audio, tmp_result, args.outfile)
